...
def create_all_tasks():
    ...
    for topology in Path(f'{LCDN_PATH_LKN}Topologies/TZ_small').iterdir():
        for i in range(5):
            new_paras = Settings(10, SEEDS[i], topology, i, 4, 50, LCDNStrategy.GREEDY, 1.0, RerouteStrategy.SINGLE_FLOW)
...
def run_all_tests():
    ...
    with open(f'{LCDN_PATH_LKN}Evaluations/LCDN/Paper/Flow2/rerouting_greedy_singleflow_hpn4.json', 'w') as file:
