...
def create_all_tasks():
    ...
    for topology in Path(f'{LCDN_PATH_LKN}Topologies/TZ_small').iterdir():
        for i in range(5):
            new_paras = Settings(0, SEEDS[i], topology, i, 4, 50, LCDNStrategy.NOTGREEDY, 1.0)
...
def run_all_tests():
    ...
    with open(f'{LCDN_PATH_LKN}Evaluations/LCDN/Paper/Flow2/notgreedy_hpn4.json', 'w') as file:
